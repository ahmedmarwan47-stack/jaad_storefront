    ...
    body = """
      <section class="py-20">
        <div class="flex flex-col items-center gap-5 mx-auto px-4 max-w-[560px] text-center">
          <span class="place-items-center grid bg-cream rounded-full size-24">
          ...
          <h1 class="font-medium text-heading text-[32px] md:text-[40px] leading-[1.2]">المتجر مغلق حالياً</h1>
          <p class="text-muted text-base xl:text-lg leading-8">
